# Memoria T‚cnica - Parte 1: Entornos de Trabajo 
 
Documentaci¢n completa de la configuraci¢n, incidencias resueltas y verificaci¢n de los entornos para Scala 2.12.21 y Java 17. 
 
--- 
 
## 1.1 Entorno 1 - JupyterLab + Almond Kernel + Scala 2.12.21 
 
### Resoluci¢n de incidencia con pip y Python 3.12 
Durante la instalaci¢n de JupyterLab surgi¢ un problema porque la terminal no reconoc¡a el comando pip. Se solucion¢ instalando Python 3.12 y ejecutando: 
...
### Resoluci¢n de PowerShell y sbt run 
